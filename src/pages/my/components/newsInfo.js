...
class NewsInfo extends Component {
    ...
    getInfo(){
        axios.get("/news/detail.api?newsId=1599725&t=201912112295723324")
        .then(res=>{
            console.log(res)
        })
    }
            ...
            <Fragment>
                <div>
                    ...
                    <div className="newsBox">
                        <h2>Netflix原创剧《冰上旅程》曝中字预告</h2>
                        <div className="othersBox">
                            <time>2019-12-11 14:01:30</time>
                            <div className="spanBox">
                                <span className="comment">评论1</span>
                    ...
                    <div className="bottomBar">
                        ...
                        <span className="messageNum">2</span>
